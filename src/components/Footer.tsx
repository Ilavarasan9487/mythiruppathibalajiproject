...
export default function Footer() {
  return (
    <footer className="bg-brand-blue text-gray-300 pt-16 pb-8 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2 pr-0 md:pr-12">
            <h3 className="font-serif text-3xl text-brand-gold font-bold mb-6">
              Thirupathi Balaji Travels
            </h3>
            <p className="text-base leading-relaxed text-pretty max-w-md mb-8 text-gray-400">
          ...
          <div>
            ...
            <ul className="space-y-5 text-base text-gray-400">
              ...
              <li className="flex items-center">
                ...
                <span>bookings@thirupathibalajitravels.com</span>
              </li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-slate-800 pt-8 text-sm text-gray-500 flex flex-col md:flex-row justify-between items-center">
